...
public class InfectedAstronaut : Enemy
{
    ...
    /// <summary>
    /// Players the initial transformation of the boss
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Fires the bosses shotgun at the player if bool CanShoot is true in the update method
    /// </summary>
    ...
    /// <summary>
    /// This is the same code as the players dash but works slightly differently 
    /// as the boss can not choose a direction to dash like the player a random number
    /// between 1 and 8 is generated, with each of these numbers corresponding to a direction.
    /// Furthermore, to balance the bosses dash a probability is calculated be generating
    /// a random number between 1 and 100, if the number is above the DashPercentage then 
    /// the boss will perform a dash
    /// </summary>
    /// <returns></returns>
